...
//  lazy val schema = Array(Contracts.schema, Corporations.schema, Currencies.schema, DsBars.schema, DsInputs.schema, DsMeta.schema, DsPecks.schema, Exchanges.schema, MdFeeds.schema, MdFeedsExchanges.schema, MdSeries.schema, MdVendors.schema, RfCoaCode.schema, RfLineItems.schema, RfStatements.schema).reduceLeft(_ ++ _)
...
//  def MdFeedsFromId(id: MdfeedId) = (MdFeeds filter { _.id === id }).result 
//
//  /**
